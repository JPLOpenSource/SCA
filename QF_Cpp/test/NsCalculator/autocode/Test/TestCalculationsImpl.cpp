...
// Created on: 30-Jul-2011 10:20:43
...
#include <My/UI/StatechartSignals.h>
#include <Test/StatechartSignals.h>
...
void TestCalculationsImpl::stageNextCalculation () {
	...
	if (this->idx < CALC_TEST_SIZE) {
		...
		QF::publish(Q_NEW(QEvent, Test::TEST_LIST_DONE));
	}
}
...
void TestCalculationsImpl::sendNextChar () {
	...
	switch (c) {
	case '+':
		QF::publish(Q_NEW(My::KeyEvent, My::UI::B_OP_PLUS));
		break;
	case '-':
		QF::publish(Q_NEW(My::KeyEvent, My::UI::B_OP_MINUS));
		break;
	case '*':
		QF::publish(Q_NEW(My::KeyEvent, My::UI::B_OP_TIMES));
		break;
	case '/':
		QF::publish(Q_NEW(My::KeyEvent, My::UI::B_OP_DIVIDE));
		break;
	case '=':
		QF::publish(Q_NEW(My::KeyEvent, My::UI::B_EQUAL));
		break;
	case '.':
		QF::publish(Q_NEW(My::KeyEvent, My::UI::B_DOT));
		break;
	case '0':
		QF::publish(Q_NEW(My::KeyEvent, My::UI::B_0));
		break;
	case '1':
		QF::publish(Q_NEW(My::KeyEvent, My::UI::B_1));
		break;
	case '2':
		QF::publish(Q_NEW(My::KeyEvent, My::UI::B_2));
		break;
	case '3':
		QF::publish(Q_NEW(My::KeyEvent, My::UI::B_3));
		break;
	case '4':
		QF::publish(Q_NEW(My::KeyEvent, My::UI::B_4));
		break;
	case '5':
		QF::publish(Q_NEW(My::KeyEvent, My::UI::B_5));
		break;
	case '6':
		QF::publish(Q_NEW(My::KeyEvent, My::UI::B_6));
		break;
	case '7':
		QF::publish(Q_NEW(My::KeyEvent, My::UI::B_7));
		break;
	case '8':
		QF::publish(Q_NEW(My::KeyEvent, My::UI::B_8));
		break;
	case '9':
		QF::publish(Q_NEW(My::KeyEvent, My::UI::B_9));
		break;
	default:
