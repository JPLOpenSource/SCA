...
//===========================================================================
//
//       File: Test/TestCalculationsImpl.h
...
//===========================================================================
#ifndef TestTestCalculationsImpl_h
#define TestTestCalculationsImpl_h

#include <qf_port.h>
#include <qassert.h>
#include <My/Calc/Calculator.h>
...
public:
    ...
    static const int PRIO_CALC = 3;  // hardwired priority level for Calc
...
#endif  /* TestTestCalculationsImplImpl_h */
