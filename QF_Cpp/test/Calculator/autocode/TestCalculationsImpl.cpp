...
bool TestCalculationsImpl::isInOperand2 () {
	printf("in Operand2? '%d'\n", this->calcActive->isIn((QStateHandler) &Calculator::operand2));
	return this->calcActive->isIn((QStateHandler) &Calculator::operand2);
}
...
void TestCalculationsImpl::initTest () {
	this->calcActive = QF::active_[TestCalculationsImpl::PRIO_CALC];
