...
//===========================================================================
//
//       File: My/Calc/OperandXImpl.cpp
// Created on: 30-Jul-2011 10:20:30
...
#include <My/Calc/OperandXImpl.h>
...
void OperandXImpl::fraction () {
	My::KeyEvent* ke = Q_NEW(My::KeyEvent, OperandChanged);
	ke->keyId = '.';
	QF::publish(ke);
}
...
void OperandXImpl::insert (QEvent const* e) {
	My::KeyEvent* ke = Q_NEW(My::KeyEvent, OperandChanged);
	ke->keyId = (static_cast<My::KeyEvent const*>(e))->keyId;
	QF::publish(ke);
}
