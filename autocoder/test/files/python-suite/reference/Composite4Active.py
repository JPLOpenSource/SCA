...
File: Composite4Active.py

Automatically generated Composite4 state machine.
Date Created:  8 Sept. 2009
Created By:    reder

Python implementation of the Composite4 Statechart model
...
LOGGER = logging.getLogger('Composite4Logger')
...
class Composite4Active(active.Active):
    """
    Composite4 state machine active object.
    """
    def __init__(self, impl_object=None, window_name="composite4"):
        """
        Constructor
        """
        ...
        # For GUI messages
        self.__machine_name = "Composite4"
...
def main():
    ...
    composite4 = Composite4Active()
    # start active object register into qf
    composite4.startActive()
    # start/initialize HSM
    composite4.onStart(composite4.top)
