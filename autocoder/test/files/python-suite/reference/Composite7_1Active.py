...
class Composite7_1Active(active.Active):
    ...
    """
    def __init__(self, impl_object=None, window_name="composite7_1"):
        """
        Constructor
        """
    ...
    def __InternalHandler1(self):
        """
        Implementation method for InternalHandler1()
        """
        if self.__impl_obj != None:
            impl_obj = self.__impl_obj
            if "InternalHandler1" in dir(self.__impl_obj):
                # Execute self.__impl_obj.InternalHandler1() here.
                e = "impl_obj." + "InternalHandler1()"
                eval(e, {}, locals() )
            else:
                printf("Warning: InternalHandler1() is not implemented!")
        else:
            printf("Warning: no implementation object for InternalHandler1()")
