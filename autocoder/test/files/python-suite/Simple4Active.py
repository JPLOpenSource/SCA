...
File: Simple4Active.py

Automatically generated Simple4 state machine.
Date Created:  29-Sep-2009 16:54:45
Created By:    reder

Python implementation of the Simple4 Statechart model
...
class Simple4Active(active.Active):
    """
    ...
    def __init__(self, impl_object=None):
        ...
        # For GUI messages
        self.__machine_name = "Simple4"
        self.__window_name = "simple4"
