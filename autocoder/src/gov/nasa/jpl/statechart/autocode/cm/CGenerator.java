...
/**
 * This generator writes C output using velocity templates. The workflow is:<ol>
 ...
 *
 */
@GeneratorKind(IGenerator.Kind.Cm)
public class CGenerator extends AbstractGenerator {
    ...
    public CGenerator () {
        ...
        addWriter(CQuantumStateMachineWriter.class, ModelGroup.class);

        // Check if we should generate an application main file
        if (Autocoder.ifDefineMain() && !Autocoder.hasOutputDir()) {
            addWriter(CMainWriter.class, ModelGroup.class);
        }
