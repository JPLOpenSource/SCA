...
#include <usereventtest_impl.h>
#include <statechart_signals.h>

usereventtest_impl* usereventtest_impl_constructor (usereventtest_impl* mepl) {
...
void usereventtest_impl_destructor (usereventtest_impl* mepl) {
