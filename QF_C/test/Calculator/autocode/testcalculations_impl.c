...
#include <testcalculations_impl.h>
...
testcalculations_impl* testcalculations_impl_constructor (testcalculations_impl* mepl) {
...
void testcalculations_impl_destructor (testcalculations_impl* mepl) {
