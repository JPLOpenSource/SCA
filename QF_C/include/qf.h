...
/****************************************************************************/
    ...
    * \note this macro must be consistenet with #QF_ACTIVE_SUPER_ definition.
    *
    * [SWC 2013.02.13] Modified to set ignore_dropped flag to ignore.
    */
    #define QF_ACTIVE_DISPATCH_(me_, e_) \
        (me_)->ignore_dropped = true; \
...
*
* \note The LIFO policy should be used only for self-posting and with great
...
*/
uint8_t QActive_recall(QActive *me, struct QEQueueTag *eq);
...
*/
QTimeEvtCtr QTimeEvt_ctr(QTimeEvt *me);
...
* is initialized with the signal \a sig_. Internally, the macro calls the
