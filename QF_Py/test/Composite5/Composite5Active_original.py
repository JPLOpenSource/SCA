...
class Composite5Active(active.Active):
    ...
    def initialize(self):
        ...
        self.__s1_timeout = time_event.TimeEvt(self,  "S1TimerEv")
        self.__s2_timeout = time_event.TimeEvt(self,  "S2TimerEv")
        self.__s21_timeout = time_event.TimeEvt(self, "S21TimerEv")
        self.__s22_timeout = time_event.TimeEvt(self, "S22TimerEv")
    ...
    def S1(self):
        ...
        if self.tEvt['sType'] == "init":
            ...
            printf("%s %s %s", machine, stateName, "ENTRY")
            self.sendUpdate(stateName,"ENTRY")
            self.__s1_timeout.postIn(1)
            return 0
        elif self.tEvt['sType'] == "exit":
            printf("%s %s %s", machine, stateName, "EXIT")
            self.sendUpdate(stateName,"EXIT")
            self.__s1_timeout.disarm()
            return 0
    ...
    def S2(self):
        ...
        if self.tEvt['sType'] == "init":
            ...
            printf("%s %s %s", machine, stateName, "ENTRY")
            self.sendUpdate(stateName,"ENTRY")
            self.__s2_timeout.postIn(5)
            return 0
        elif self.tEvt['sType'] == "exit":
            printf("%s %s %s", machine, stateName, "EXIT")
            self.sendUpdate(stateName,"EXIT")
            self.__s2_timeout.disarm()
            return 0
        elif self.tEvt['sType'] == "S2TimerEv":
            printf("%s %s", stateName, self.tEvt['sType'])
    ...
    def S21(self):
        ...
        if self.tEvt['sType'] == "init":
            ...
            printf("%s %s %s", machine, stateName, "ENTRY")
            self.sendUpdate(stateName,"ENTRY")
            self.__s21_timeout.postIn(3)
            return 0
        elif self.tEvt['sType'] == "exit":
            printf("%s %s %s", machine, stateName, "EXIT")
            self.sendUpdate(stateName,"EXIT")
            self.__s21_timeout.disarm()
            return 0
    ...
    def S22(self):
        ...
        if self.tEvt['sType'] == "init":
            ...
            printf("%s %s %s", machine, stateName, "ENTRY")
            self.sendUpdate(stateName,"ENTRY")
            self.__s22_timeout.postIn(1)
            return 0
        elif self.tEvt['sType'] == "exit":
            printf("%s %s %s", machine, stateName, "EXIT")
            self.sendUpdate(stateName,"EXIT")
            self.__s22_timeout.disarm()
            return 0
